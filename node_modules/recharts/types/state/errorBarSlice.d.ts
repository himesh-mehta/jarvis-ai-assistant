...
export declare const addErrorBar: import("@reduxjs/toolkit/dist/index.d.mts").ActionCreatorWithPayload<{
    itemId: GraphicalItemId;
    errorBar: ErrorBarsSettings;
}, "errorBars/addErrorBar">, replaceErrorBar: import("@reduxjs/toolkit/dist/index.d.mts").ActionCreatorWithPayload<{
    itemId: GraphicalItemId;
    prev: ErrorBarsSettings;
    next: ErrorBarsSettings;
}, "errorBars/replaceErrorBar">, removeErrorBar: import("@reduxjs/toolkit/dist/index.d.mts").ActionCreatorWithPayload<{
    itemId: GraphicalItemId;
    errorBar: ErrorBarsSettings;
}, "errorBars/removeErrorBar">;
export declare const errorBarReducer: import("redux/dist/redux").Reducer<ErrorBarsState>;
