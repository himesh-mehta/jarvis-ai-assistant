...
export declare const addCartesianGraphicalItem: import("@reduxjs/toolkit/dist/index.d.mts").ActionCreatorWithPreparedPayload<[payload: CartesianGraphicalItemSettings], CartesianGraphicalItemSettings, "graphicalItems/addCartesianGraphicalItem", never, unknown>, replaceCartesianGraphicalItem: import("@reduxjs/toolkit/dist/index.d.mts").ActionCreatorWithPreparedPayload<[payload: ReplacePayload<CartesianGraphicalItemSettings>], ReplacePayload<CartesianGraphicalItemSettings>, "graphicalItems/replaceCartesianGraphicalItem", never, unknown>, removeCartesianGraphicalItem: import("@reduxjs/toolkit/dist/index.d.mts").ActionCreatorWithPreparedPayload<[payload: CartesianGraphicalItemSettings], CartesianGraphicalItemSettings, "graphicalItems/removeCartesianGraphicalItem", never, unknown>, addPolarGraphicalItem: import("@reduxjs/toolkit/dist/index.d.mts").ActionCreatorWithPreparedPayload<[payload: PolarGraphicalItemSettings], PolarGraphicalItemSettings, "graphicalItems/addPolarGraphicalItem", never, unknown>, removePolarGraphicalItem: import("@reduxjs/toolkit/dist/index.d.mts").ActionCreatorWithPreparedPayload<[payload: PolarGraphicalItemSettings], PolarGraphicalItemSettings, "graphicalItems/removePolarGraphicalItem", never, unknown>;
export declare const graphicalItemsReducer: import("redux/dist/redux").Reducer<GraphicalItemsState>;
export { };
