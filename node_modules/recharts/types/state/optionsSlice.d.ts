import { TooltipEventType } from 'recharts/types/util/types';
...
export declare const optionsReducer: import("redux/dist/redux").Reducer<ChartOptions>;
export declare const createEventEmitter: import("@reduxjs/toolkit/dist/index.d.mts").ActionCreatorWithoutPayload<"options/createEventEmitter">;
