...
import { CartesianViewBoxRequired, Coordinate, DataKey, PolarCoordinate } from 'recharts/types/util/types';
...
export declare const addTooltipEntrySettings: import("@reduxjs/toolkit/dist/index.d.mts").ActionCreatorWithPreparedPayload<[payload: TooltipPayloadConfiguration], TooltipPayloadConfiguration, "tooltip/addTooltipEntrySettings", never, unknown>, replaceTooltipEntrySettings: import("@reduxjs/toolkit/dist/index.d.mts").ActionCreatorWithPreparedPayload<[payload: {
    prev: TooltipPayloadConfiguration;
    next: TooltipPayloadConfiguration;
}], {
    prev: TooltipPayloadConfiguration;
    next: TooltipPayloadConfiguration;
}, "tooltip/replaceTooltipEntrySettings", never, unknown>, removeTooltipEntrySettings: import("@reduxjs/toolkit/dist/index.d.mts").ActionCreatorWithPreparedPayload<[payload: TooltipPayloadConfiguration], TooltipPayloadConfiguration, "tooltip/removeTooltipEntrySettings", never, unknown>, setTooltipSettingsState: import("@reduxjs/toolkit/dist/index.d.mts").ActionCreatorWithPayload<TooltipSettingsState, "tooltip/setTooltipSettingsState">, setActiveMouseOverItemIndex: import("@reduxjs/toolkit/dist/index.d.mts").ActionCreatorWithPayload<GraphicalItemTooltipActionPayload, "tooltip/setActiveMouseOverItemIndex">, mouseLeaveItem: import("@reduxjs/toolkit/dist/index.d.mts").ActionCreatorWithoutPayload<"tooltip/mouseLeaveItem">, mouseLeaveChart: import("@reduxjs/toolkit/dist/index.d.mts").ActionCreatorWithoutPayload<"tooltip/mouseLeaveChart">, setActiveClickItemIndex: import("@reduxjs/toolkit/dist/index.d.mts").ActionCreatorWithPayload<GraphicalItemTooltipActionPayload, "tooltip/setActiveClickItemIndex">, setMouseOverAxisIndex: import("@reduxjs/toolkit/dist/index.d.mts").ActionCreatorWithPayload<AxisTooltipActionPayload, "tooltip/setMouseOverAxisIndex">, setMouseClickAxisIndex: import("@reduxjs/toolkit/dist/index.d.mts").ActionCreatorWithPayload<AxisTooltipActionPayload, "tooltip/setMouseClickAxisIndex">, setSyncInteraction: import("@reduxjs/toolkit/dist/index.d.mts").ActionCreatorWithPayload<TooltipSyncState, "tooltip/setSyncInteraction">, setKeyboardInteraction: import("@reduxjs/toolkit/dist/index.d.mts").ActionCreatorWithPayload<KeyboardTooltipActionPayload, "tooltip/setKeyboardInteraction">;
export declare const tooltipReducer: import("redux/dist/redux").Reducer<TooltipState>;
