...
export declare const setChartData: import("@reduxjs/toolkit/dist/index.d.mts").ActionCreatorWithOptionalPayload<ChartData | undefined, "chartData/setChartData">, setDataStartEndIndexes: import("@reduxjs/toolkit/dist/index.d.mts").ActionCreatorWithPayload<Partial<BrushStartEndIndex>, "chartData/setDataStartEndIndexes">, setComputedData: import("@reduxjs/toolkit/dist/index.d.mts").ActionCreatorWithNonInferrablePayload<"chartData/setComputedData">;
export declare const chartDataReducer: import("redux/dist/redux").Reducer<ChartDataState>;
