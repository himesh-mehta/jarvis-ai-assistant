...
Reply in pure JSON only (no markdown, no backticks):
{
  ...
  "refined_prompt": "rewritten prompt optimized for chosen tool"
}`;
...
// ## Thing 2 — Build the Command to JARVIS UI

// Want me to write the complete frontend page now? It will look like this:
// ```
// ┌─────────────────────────────────┐
// │  Command to JARVIS              │
// │                                 │
